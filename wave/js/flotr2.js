    ...
    Flotr = {
        ...
        engineeringNotation: function(value, precision, base) {
            var sizes = ['Y', 'Z', 'E', 'P', 'T', 'G', 'M', 'k', ''],
                fractionSizes = ['y', 'z', 'a', 'f', 'p', 'n', 'Вµ', 'm', ''],
                total = sizes.length;
...
Flotr.defaultOptions = {
    ...
    xaxis: {
        ...
        timeUnit: 'millisecond', // => Unit for time (millisecond, second, minute, hour, day,В month, year)
...
(function() {
    ...
    Graph.prototype = {
        ...
        calculateSpacing: function() {
            ...
            // Title height
            dim = T.dimensions(
                options.title, { size: options.fontSize * 1.5 },
            ...
            // Subtitle height
            dim = T.dimensions(
                options.subtitle, { size: options.fontSize },
                'font-size:smaller;',
                'flotr-subtitle'
            );
        ...
        getOptions: function(series, typeKey) {
            ...
            options.fillStyle = this.processColor(
                type.fillColor || series.color, { opacity: type.fillOpacity }
            );
    ...
    Axis.prototype = {
        ...
        calculateTextDimensions: function(T, options) {
            ...
            this.maxLabel = T.dimensions(
                maxLabel, { size: options.fontSize, angle: Flotr.toRad(this.options.labelsAngle) },
                'font-size:smaller;',
                'flotr-grid-label'
            );

            this.titleSize = T.dimensions(
                this.options.title, { size: options.fontSize * 1.2, angle: Flotr.toRad(this.options.titleAngle) },
                'font-weight:bold;',
                'flotr-axis-title'
            );
        },
